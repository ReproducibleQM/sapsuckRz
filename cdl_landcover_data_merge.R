...
crops <- fread("https://raw.githubusercontent.com/ReproducibleQM/sapsuckRz/master/Data/cdl_landcover_data.csv", header = TRUE)
sites.crops <- merge(sites, cdl_sort, all=TRUE, by.x = c("Site","Year","State"), by.y = c("ID","Year","State"))
