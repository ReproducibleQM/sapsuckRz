...
data<-merge(aphid.all,weather.cast,by=c("site.id","year","doy"),all=T)

#Calculate rolling averages degree day accumulation
...
#Calculate total precipitation before peak
